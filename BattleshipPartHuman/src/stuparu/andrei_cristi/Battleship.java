				...
				while(again==1) {
					...
					while(step2 == 0) {
						...
						step2=1;
							...
							if (choice==1) {
								playerH1.myBoard.showBoard();
								System.out.println("When you are done watching press 1 to erase your traces!");
							...
							if(playerTurn==1) {
								...
								if(firstRound==1) {
									if(resultplayer2 == 1) {
										...
										playerH1.myBoard.showBoard();
										System.out.println("When you are ready to attack please insert any number");
										rdy = scanner.nextInt();
										scanner.nextLine();
								...
								while(endround1 == 0) {
									...
									if(coordVerify(missile,sizeBoardX,sizeBoardY)) {
								...
								if(winner.equals("None")) {
									System.out.println("When you are ready to end your turn please insert any number");
									rdy = scanner.nextInt();
